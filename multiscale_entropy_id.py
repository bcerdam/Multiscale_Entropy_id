...
# utils_id.plot_arrays(mse_values_1d, title='Multiscale Entropy 1D: White Noise', xlabel='Scales', ylabel='Entropy')
...
# utils_id.plot_arrays(mse_values_2d, title='Multiscale Entropy 2D: White Noise', xlabel='Scales', ylabel='Entropy')
